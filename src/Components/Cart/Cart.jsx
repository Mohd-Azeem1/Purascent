...
function Cart() {
  ...
  return (
    <div id="cart" className="w-full min-h-screen pt-14">
      <div
        id="collection-banner-photo"
        className="w-full h-[20vw] flex flex-wrap justify-between"
      ></div>
      <div className="w-full h-[10vh] bg-[#714486] px-10 text-white flex justify-center items-center">
        <h1 className="md:text-[1.5vw] text-[5vw] junge">WELCOME TO YOUR CART</h1>
      </div>
      {bucket.length === 0 ? (
