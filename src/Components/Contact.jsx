      ...
      >
        ...
        <div className="flex flex-col junge justify-start gap-5 items-start p-20 text-white w-full min-h-screen backdrop-blur-md">
          ...
          <div className="w-full flex flex-col justify-center items-center gap-5">
            <h1 className="arizonia text-[2.5vw] text-[#EABEFF]">Email</h1>
            <h2 className="junge text-[1.5vw]">
              Send us an email at msajifdf123@gmail.com and we'll get back to
              you as soon as possible.
            </h2>
            <h1 className="arizonia text-[2.5vw] text-[#EABEFF]">Phone</h1>
            <h2 className="junge text-[1.5vw]">
            ...
            <div className="text-center">
              <h2 className="junge text-[1.2vw]">
                Monday to Friday: 9:00 AM - 6:00 PM (EST)
              </h2>
              <h2 className="junge text-[1.2vw]">
                Saturday: 10:00 AM - 4:00 PM (EST)
              </h2>
              <h2 className="junge text-[1.2vw]">Sunday: Closed</h2>
            </div>
            <h1 className="arizonia text-[2.5vw] text-[#EABEFF]">Address</h1>
            <h2 className="junge text-[1.5vw]">
              You can also visit us at our physical location:
            </h2>
            <div className="text-center">
              <h2 className="junge text-[1.2vw]">Purascent Headquarters</h2>
              <h2 className="junge text-[1.2vw]">123 Fragrance Avenue</h2>
              <h2 className="junge text-[1.2vw]">Cityville, State, Zip Code</h2>
              <h2 className="junge text-[1.2vw]">Country</h2>
            </div>
            <h1 className="arizonia text-[2.5vw] text-[#EABEFF]">
              Social Media
            </h1>
            <h2 className="junge text-[1.5vw]">
